...
const zipName = "UPLOAD-TO-GHOST-bomsociety-theme-v2.0.2.zip";
...
async function createInspectableTheme({ homeMarker = true } = {}) {
  ...
  await writeFile(join(theme, "package.json"), '{"version":"2.0.2"}');
...
test("the built ZIP contains markers in every required homepage template", () => {
  ...
  const zip = "releases/UPLOAD-TO-GHOST-bomsociety-theme-v2.0.2.zip";
...
test("upload and activation use the inspected v2.0.2 ZIP and returned Ghost name", () => {
