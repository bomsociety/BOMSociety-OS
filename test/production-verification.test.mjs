...
const basePage = `<!doctype html><title>BOMSociety | Physician Decision Intelligence</title><link rel="canonical" href="https://www.bomsociety.com/"><meta name="bomsociety-theme-version" content="1.3.3"><meta name="bomsociety-deployment-marker" content="BOMSOCIETY-SPRINT-17B-CANONICAL"><main data-bomsociety-home="BOMSOCIETY-HOMEPAGE-V2" data-compensation-pathway><h1>What decision could change your career forever?</h1><aside data-win-reveal></aside><form data-situation-form></form></main>`;
...
test("missing homepage structure fails while shared metadata remains", () => {
  expectFailure("ROUTE_BYPASSES_UPDATED_TEMPLATE", `<link rel="canonical" href="https://www.bomsociety.com/"><meta name="bomsociety-theme-version" content="1.3.3"><meta name="bomsociety-deployment-marker" content="BOMSOCIETY-SPRINT-17B-CANONICAL">`);
...
test("missing version and deployment metadata fail with specific codes", () => {
  expectFailure("WRONG_THEME_VERSION", basePage.replace('name="bomsociety-theme-version" content="1.3.3"', ""));
