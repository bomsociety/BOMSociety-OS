...
test("missing homepage structure fails while shared metadata remains", () => {
  expectFailure("ROUTE_BYPASSES_UPDATED_TEMPLATE", `<link rel="canonical" href="https://www.bomsociety.com/"><meta name="bomsociety-theme-version" content="2.0.2"><meta name="bomsociety-deployment-marker" content="BOMSOCIETY-SPRINT-17B-CANONICAL">`);
...
test("missing version and deployment metadata fail with specific codes", () => {
  expectFailure("WRONG_THEME_VERSION", basePage.replace('name="bomsociety-theme-version" content="2.0.2"', ""));
