...
const basePage = `<!doctype html><meta name="bomsociety-theme-version" content="1.3.2"><meta name="bomsociety-deployment-marker" content="BOMSOCIETY-SPRINT-17B-CANONICAL"><main data-bomsociety-home="BOMSOCIETY-DECISION-OS"><aside data-decision-score></aside><aside data-decision-intelligence></aside></main>`;
...
test("current homepage passes production verification without the temporary red banner", () => {
  ...
  assert.deepEqual(result, {
    ...
    decisionIntelligenceFound: true, compensationPathwayFound: true, retiredHomepageFound: false
  });
});

test("missing homepage structure fails while shared metadata remains", () => {
  expectFailure("ROUTE_BYPASSES_UPDATED_TEMPLATE", `<meta name="bomsociety-theme-version" content="1.3.2"><meta name="bomsociety-deployment-marker" content="BOMSOCIETY-SPRINT-17B-CANONICAL">`);
